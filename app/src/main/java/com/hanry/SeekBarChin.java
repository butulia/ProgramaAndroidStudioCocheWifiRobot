...
public class SeekBarChin extends AbsSeekBar{
	...
	public interface OnSeekBarChangeListener {
		void onProgressChanged(SeekBarChin VerticalSeekBar, int progress,
				boolean fromUser);

		void onStartTrackingTouch(SeekBarChin VerticalSeekBar);

		void onStopTrackingTouch(SeekBarChin VerticalSeekBar);
	}

	private OnSeekBarChangeListener mOnSeekBarChangeListener;

	public SeekBarChin(Context context) {
		this(context, null);
	}

	public SeekBarChin(Context context, AttributeSet attrs) {
		this(context, attrs, android.R.attr.seekBarStyle);
	}

	public SeekBarChin(Context context, AttributeSet attrs, int defStyle) {
